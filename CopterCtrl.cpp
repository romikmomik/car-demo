...
void CopterCtrl::initMotors(const QString& motorControlPath)
{
	...
	m_rightMotor = new CopterMotor(powerMin, powerMax, motorControlPath + "ehrpwm.0/pwm/ehrpwm.0:1/" + motorControlFile, m_settings, "Right");
	m_leftMotor = new CopterMotor(powerMin, powerMax, motorControlPath + "ehrpwm.1/pwm/ehrpwm.1:1/" + motorControlFile, m_settings, "Left");
